 ...
 *     var Tree = docooment.model('Tree', schema);
 *
 ...
 *
 * Keys in this object are names that are rejected in schema declarations b/c they conflict with docooment functionality. Using these key name will throw an error.
 *
 *      on, emit, _events, db, get, set, init, isNew, errors, schema, options, modelName, collection, _pres, _posts, toObject
 *
 * _NOTE:_ Use of these terms as method names is permitted, but play at your own risk, as they may be existing docooment document methods you are stomping on.
 *
...
/**
 * Converts type arguments into Docooment Types.
 *
 * @param {String} path
 ...
 *     });
 *
 *     var Model = docooment.model('Model', schema);
 *
 *     var m = new Model(..);
 *     m.save(function (err) {
 ...
 *     })
 *
 *     var Kitty = docooment.model('Kitty', schema);
 *
 *     var fizz = new Kitty;
 ...
 *     });
 *
 *     var Drink = docooment.model('Drink', schema);
...
/**
 * The various built-in Docooment Schema Types.
 *
 * ####Example:
 *
 *     var docooment = require('docooment');
 *     var ObjectId = docooment.Schema.Types.ObjectId;
 *
 * ####Types:
 *
 ...
 *
 *     var Mixed = docooment.Schema.Types.Mixed;
 *     new docooment.Schema({ _user: Mixed })
 *
 * @api public
 */
